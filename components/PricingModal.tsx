  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#101918]/60 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 overflow-hidden font-manrope">
      ...
      <div className="relative w-full max-w-6xl bg-white dark:bg-[#1e2827] rounded-2xl shadow-2xl flex flex-col max-h-[95vh] overflow-y-auto sidebar-scroll animate-fade-in-up transition-all duration-300">
        ...
        <div className="relative bg-gradient-to-br from-primary/10 to-primary/30 px-6 py-4 sm:px-10 sm:py-6 text-center shrink-0">
          ...
          <h2 className="relative text-[#101918] dark:text-white text-lg sm:text-xl md:text-2xl font-extrabold leading-tight tracking-tight mb-2 px-4">
        ...
        <div className="px-4 py-4 sm:px-10 sm:py-6 bg-[#fbfdfd] dark:bg-[#1e2827]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-4 items-stretch max-w-5xl mx-auto">

            {/* Free Plan */}
            <div className="flex flex-col gap-4 rounded-3xl border border-gray-200 bg-white dark:bg-[#252f2e] dark:border-gray-700 p-5 shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-[#101918] dark:text-white text-3xl font-black tracking-tight">$0</span>
                  <span className="text-gray-500 dark:text-gray-400 font-bold">/mo</span>
                </div>
              </div>
              <button
                onClick={() => alert("You are already on the Free plan.")}
                className="w-full h-11 rounded-2xl border border-gray-200 bg-gray-50 dark:bg-transparent dark:border-gray-600 dark:text-white text-[#101918] font-black text-sm transition-all cursor-default"
              >
                Current Plan
              </button>
            ...
            <div className="relative flex flex-col gap-3 rounded-3xl border-[3px] border-primary bg-white dark:bg-[#252f2e] p-4 shadow-glow transition-all duration-300 hover:shadow-2xl lg:-translate-y-2 lg:scale-105 z-10">
              {/* Badge */}
              ...
              <div className="flex flex-col gap-1 pt-2">
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-[#101918] dark:text-white text-4xl font-black tracking-tight">
              ...
              <button
                ...
                className="w-full h-11 rounded-2xl bg-primary hover:bg-teal-400 text-slate-900 font-black text-base shadow-xl shadow-primary/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
              >
                Upgrade Now
              </button>
              <div className="space-y-2 pt-3 border-t border-gray-50 dark:border-gray-800">
            ...
            {/* Enterprise Plan */}
            <div className="flex flex-col gap-4 rounded-3xl border border-gray-200 bg-white dark:bg-[#252f2e] dark:border-gray-700 p-5 shadow-sm hover:shadow-xl transition-all duration-300 md:col-span-2 lg:col-span-1">
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-[#101918] dark:text-white text-3xl font-black tracking-tight">Custom</span>
                </div>
              </div>
              <button
                onClick={() => alert("Connecting to sales team...")}
                className="w-full h-11 rounded-2xl border-2 border-gray-100 bg-white hover:bg-gray-50 dark:bg-transparent dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 text-[#101918] font-black text-sm transition-all hover:shadow-md active:scale-95"
              >
                Contact Sales
              </button>
              <div className="space-y-2 pt-3 border-t border-gray-50 dark:border-gray-800">
        ...
        {/* Footer Meta Text */}
        <div className="bg-gray-50 dark:bg-[#192221] px-6 py-4 sm:px-10 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-gray-100 dark:border-gray-800 shrink-0">
